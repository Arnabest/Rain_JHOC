...
class ErrorCode(StrEnum):
    ...
    MEMORY_CONTRADICTION_UNRESOLVED = "JHOC-MEM-001"
    INDEX_BUDGET_BREACH = "JHOC-MEM-002"
    PROBE_VERIFICATION_FAILED = "JHOC-PROBE-001"
    VERIFICATION_FAILED = "JHOC-PROBE-001"
