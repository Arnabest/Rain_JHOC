...
| 字段 | 必填 | 说明 |
|---|---|---|
| **主题** | [OK] | Checkpoint Plan 必须已选定。chapter agent 实现时按主题颜色 / 字体 token 走，动画 / 节奏 / 视觉演示由章节自由发挥 |
| **总时长** | [OK] | 估算口播时长（中文 ~ 250 字 / 分钟） |
| **章节数** | [OK] | `N 章 / M 步` |
...
> [WARN] **硬性流程**：outline 写完后**必须**走自检 → 修改 → 提交 三步。
