...
- [FAIL]"大家好今天我们来讲讲" 这种自我介绍开场
- [FAIL]"本期视频我们将探讨" 这种 PPT 标题感
- [FAIL]"在开始之前，让我们先了解一下背景" 这种先讲一堆铺垫
- [FAIL]"我知道你最近肯定很纠结 X / 你是不是也有这种感觉" 假共情钩子
- [FAIL]"接下来我说的，可能会颠覆你的认知" 自我加权钩子
...
- [FAIL]"首先 / 其次 / 最后"
- [FAIL]"接下来我们看下面三点"
- [FAIL]"总结一下，本期视频我们讲了什么什么"
- [FAIL]"下面进入第二部分"

**禁止**（万能模板类，AI 高频指纹 —— 详见去 AI 味第 4 类）：

- [FAIL]"说白了 ……" / "本质上 ……" / "底层逻辑是 ……"
- [FAIL]"一句话总结 ……" / "归根结底 ……" / "换句话说 ……"
...
[OK] 怎么改：直接抛事实 / 钩子（见原则 4）。亲不亲是观众听完判断的，
...
[OK] 怎么改：去掉转折包装直接说结论。**自检方法**："恰恰 / 反而 / 正
...
[OK] 怎么改：**直接说**。好观点不需要预热。担心观众划走，靠节奏（短句
+ 钩子）把人留住，不靠"加权"。
...
[OK] 怎么改：保留最有信息量的一两个，其余砍掉；或换成一个具体例子。
...
- [FAIL] **emoji**：除非用户明确要求，口播稿里不要 emoji。emoji 是文字
  弹幕，不是讲话
- [FAIL] **括号补充**："这个模型（一种基于 transformer 的架构）很厉害" ——
  括号里的话讲不出来，要么并入正文要么删
- [FAIL] **罗列书名号 / 引号**："《XX 报告》指出，XX" —— 改成"我看到一份报告说"
- [FAIL] **"哈哈哈"等口头语堆砌**：偶尔一次效果好，每段一个就成抽搐
- [FAIL] **过度网络梗**：梗有半年保鲜期；半年后看就尴尬。除非主题就是网络梗
...
> [WARN] **自检是硬性流程**：下面的三层自检（形式 / 风骨 / 念出来）写完
