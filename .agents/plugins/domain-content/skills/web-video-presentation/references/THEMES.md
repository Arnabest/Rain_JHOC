...
| 字段 | 必填 | 取值 | 决定什么 |
|---|---|---|---|
| `id` / `name` / `nameZh` | [OK] | 字符串 | 主题标识 |
| `description` / `descriptionZh` | [OK] | 一句话 | Checkpoint Plan 列清单时的简介 |
| `mood` | [OK] | 标签数组 | 模糊匹配用 |
| `bestFor` | [OK] | 场景数组 | Checkpoint Plan 智能推荐时的命中点 |
| `preview` | [OK] | 4 色对象 | Checkpoint Plan 列清单时的视觉预览 |
