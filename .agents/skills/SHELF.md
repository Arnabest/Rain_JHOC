...
> **Authority**: Governed under [`ADR-0009-registry-shelf-quota.md`](docs/adr/ADR-0009-registry-shelf-quota.md) 与 [`src/jhoc/shelf/`](src/jhoc/shelf/)
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `codex-plan-review` | `core` | `2.0.0` | `collaboration` | `codex-plan-review`, `plan-review`, `规划复核` | `VERIFIED` | [codex-plan-review](codex-plan-review/SKILL.md) |
