...
> **Authority**: Governed under **JHOC Agent 宪法体系** ([AGENTS.md`](AGENTS.md)) 与 [`anti-metaphysical-protocol.md`](.agents/rules/anti-metaphysical-protocol.md)
> **Physical Location**: .agents\skills\paper-to-knowledge-distiller\`
