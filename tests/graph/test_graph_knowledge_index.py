...
class TestGraphKnowledgeIndex(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        store.add_node(GraphNode("err:lesson-402", "ErrorRecord"))
        ...
        store.add_node(GraphNode("subsystem:shelf", "Subsystem"))
        store.add_relation(GraphRelation("r2", "subsystem:conductor", "subsystem:guard", "depends_on", 1.0, "ref", "VERIFIED", "VERIFIED"))
        store.add_relation(GraphRelation("r3", "subsystem:conductor", "subsystem:shelf", "depends_on", 1.0, "ref", "VERIFIED", "VERIFIED"))
        store.close()
