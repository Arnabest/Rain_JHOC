# 技术复盘日志：Windows 命令行应用别名陷阱：排查 Python 进程静默退出与自动化门禁假死 (2026-09-07)
...
- **所属任务归档 (Task Archive)**: [`memory/session-20260903-jhoc-governance-closure.md`](memory/session-20260903-jhoc-governance-closure.md) (`node_id: task:session-20260903-jhoc-governance-closure`) [关系: `derived_from`]
- **关联开发轨迹 (Git Commit)**: `73944da` (`node_id: commit:73944da`) [关系: `observed_in`]
- **核心受影响代码实体 (Code Entities)**:
  - [`scripts/jhoc_kaigong.py`](scripts/jhoc_kaigong.py) (`node_id: code:scripts/jhoc_kaigong.py`) [关系: `solves` / `applies_to`]
  - [`scripts/jhoc_worklog.py`](scripts/jhoc_worklog.py) (`node_id: code:scripts/jhoc_worklog.py`) [关系: `solves` / `applies_to`]
  - [`scripts/jhoc_shougong.py`](scripts/jhoc_shougong.py) (`node_id: code:scripts/jhoc_shougong.py`) [关系: `solves` / `applies_to`]
- **可证伪物理凭据套件 (Verification Evidence)**:
  - [`tests/test_skills_shelf_compliance.py`](tests/test_skills_shelf_compliance.py) (`node_id: evidence:tests/test_skills_shelf_compliance.py`) [关系: `verified_by`]
  - [`tests/test_zero_emoji_discipline.py`](tests/test_zero_emoji_discipline.py) (`node_id: evidence:tests/test_zero_emoji_discipline.py`) [关系: `verified_by`]
- **沉淀经验知识库 (Lessons Learned)**:
  - [`docs/lessons/LESSON-windows-app-alias.md`](docs/lessons/LESSON-windows-app-alias.md) (`node_id: lesson:LESSON-windows-app-alias`) [关系: `related_to`]
