...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.action in ("approve", "reject"):
        ...
        if secret_file.is_file():
            ...
            if os.environ.get("JHOC_MODEL_ID") or not token:
                print("[FAIL] Permission Denied: Operator authentication requires either runtime/.operator_secret or valid JHOC_OPERATOR_TOKEN. Autonomous self-approval is strictly forbidden.")
                return 1
